---
tags: [databases, postgresql, transactions, backend]
---
...
## Related
- [[MVCC, Vacuum & Autovacuum|MVCC]] — PostgreSQL реализует уровни изоляции через MVCC, а не блокировки
- [[Обработка SQL запроса|Query Processing]] — транзакции оборачивают выполнение запросов
- [[Распределенные базы данных]] — распределённые системы ослабляют ACID до BASE (CAP теорема)
- [[NoSQL базы данных]] — NoSQL использует BASE вместо ACID
