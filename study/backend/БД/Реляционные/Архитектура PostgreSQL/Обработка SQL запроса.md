...
## Related
- [[Фоновые процессы]] — Postmaster создаёт backend процесс для выполнения этого pipeline
- [[Индексы]] — планировщик использует статистику индексов для выбора оптимального пути
- [[Планировщик]] — детали query planner
- [[Транзакции, ACID, Уровни изоляции|Transactions]] — каждый запрос выполняется в контексте транзакции
