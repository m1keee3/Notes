...
## Related
- [[Транзакции, ACID, Уровни изоляции|Transactions & ACID]] — MVCC — механизм PostgreSQL для реализации уровней изоляции
- [[Фоновые процессы]] — Autovacuum является одним из фоновых воркеров
- [[Индексы]] — vacuum также очищает мёртвые записи в индексах
