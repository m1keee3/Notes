---
tags: [go, channels, concurrency, backend]
---
...
![[Pasted image 20251009102544.png]]
---
...
## Related
- [[Goroutine|Goroutine]] — горутины блокируются на операциях с каналами
- [[Планировщик (Scheduler)|Scheduler]] — заблокированные горутины попадают в wait queues (recvq/sendq), взаимодействуя с LRQ/GRQ
- [[Concurency|Concurrency Patterns]] — каналы используются в Pipeline и Worker Pool паттернах
- [[Context]] — context.Done() возвращает receive-only канал
