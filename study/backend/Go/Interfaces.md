...
## Related
- [[Generics]] — generics используют type constraints, определённые как интерфейсы
- [[Замыкания (Closures)|Closures]] — closures + interfaces = паттерн Strategy
- [[ООП]] — SOLID: Dependency Inversion и Interface Segregation
- [[Study/backend/Архитектуры/MOC]] — интерфейсы — механизм границ в Clean и Hexagonal архитектурах
