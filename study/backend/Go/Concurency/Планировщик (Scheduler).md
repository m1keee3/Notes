---
tags: [go, scheduler, concurrency, backend]
---
...
Можно сделать так чтобы один процессор в случае отсутствия горутин в своей локальной очереди, будет воровать горутины из LRQ другого процессора.
...
## Related
- [[Goroutine]] — структура горутины (объект `g`, которым управляет планировщик)
- [[Каналы (Channels) Внутреннее устройство|Channels]] — каналы используют wait queues (recvq/sendq), взаимодействующие с LRQ/GRQ
- [[Планировщик процессов]] — OS-планировщик (FCFS, RR, SJF), поверх которого работает Go runtime
- [[Garbage Collector]] — GC и планировщик взаимодействуют: safe points — это точки вытеснения
- [[Память]] — стеки горутин управляются в рамках модели памяти Go
