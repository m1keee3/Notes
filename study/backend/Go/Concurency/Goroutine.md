---
tags: [go, goroutine, concurrency, backend]
---
...
## Related
- [[Планировщик (Scheduler)]] — как горутины планируются (GMP модель)
- [[Concurency]] — WaitGroup, Mutex, Pipeline, Worker Pool паттерны
- [[Каналы (Channels) Внутреннее устройство|Channels]] — основной механизм коммуникации между горутинами
- [[Context]] — передача отмены и таймаутов через горутины
- [[Процессы]] — OS процессы vs горутины
