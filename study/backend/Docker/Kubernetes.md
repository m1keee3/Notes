---
tags: [kubernetes, docker, devops, backend]
---
...
## Related
- [[Image & Container]] — Kubernetes оркестрирует Docker-контейнеры
- [[Docker Compose]] — Compose для локальной разработки; Kubernetes — продакшн аналог
- [[Deploy]] — Kubernetes — кульминация workflow деплоя
- [[Study/backend/Сети/MOC|Networks]] — сетевая модель Kubernetes (ClusterIP, NodePort, Ingress) строится на OSI
