---
tags: [docker, containers, devops, backend]
---
...
## Related
- [[DockerFile 🐳|Dockerfile]] — Dockerfile определяет как собирается образ
- [[Docker Compose]] — Compose управляет несколькими контейнерами вместе
- [[Kubernetes]] — Kubernetes оркестрирует контейнеры в масштабе
- [[Deploy]] — контейнеры решают проблему ручного деплоя
- [[Виртуальная машина]] — контейнеры vs VM: оба дают изоляцию, разными способами
