---
tags: [concurrency, performance, backend]
---
...
## Related
- [[Goroutine|Goroutines]] — горутины идеальны для I/O-bound задач (паркуются при ожидании, освобождая OS поток)
- [[Планировщик (Scheduler)|Go Scheduler]] — Network Poller в планировщике спроектирован для async I/O-bound операций
- [[Планировщик процессов]] — OS планировщик по-разному обрабатывает I/O-bound и CPU-bound процессы
