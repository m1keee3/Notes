---
tags: [kafka, messaging, distributed, backend]
---
...
## Related
- [[Распределенные базы данных]] — CAP теорема применима к кластеру Kafka; Kafka предпочитает AP
- [[NoSQL базы данных]] — Kafka иногда относят к key-value хранилищам (log-structured)
- [[../../../Personal/Projects/Finly/README|Finly]] — Watcher сервис публикует уведомления через Kafka
- [[../../../Personal/Projects/Finly/TECH|Finly Tech Stack]] — семантика доставки Kafka в контексте Finly
