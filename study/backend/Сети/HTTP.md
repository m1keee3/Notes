...
## Related
- [[OSI]] — HTTP — протокол прикладного уровня (L7)
- [[TCP & UDP]] — HTTP/1.1 работает поверх TCP; HTTP/2 тоже TCP, но мультиплексирован
- [[API]] — REST — архитектурный стиль поверх HTTP; gRPC использует HTTP/2
- [[Как работает браузер]] — HTTP — протокол в жизненном цикле запроса браузера
