---
tags: [networks, api, grpc, rest, backend]
---
...
## Related
- [[HTTP]] — REST использует HTTP/1.1; gRPC использует HTTP/2
- [[OSI]] — оба стиля API работают на прикладном уровне
- [[TCP & UDP]] — транспорт для обоих стилей API
- [[Study/backend/Архитектуры/MOC]] — выбор стиля API — архитектурное решение
- [[Projects/Finly/README|Finly]] — gRPC для внутреннего взаимодействия сервисов, REST на Gateway
